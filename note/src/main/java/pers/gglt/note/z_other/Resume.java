...
public class Resume {
    ...
    /**自我介绍*/
    // 面试官你好,我叫郭龙腾,来自广州应用科技学院,物联网工程专业,目前正在从事安卓开发,约有1年半的安卓开发经验.
    // 工作上主要担任门禁系统的开发与日常维护,以及轨迹监控系统的客户端开发.涉及人脸识别,安卓原生开发,视频通话等技术
    // 领导与协调能力,学生时期参加数学建模大赛时,作为队长协调组内同学各司其职,最终取得三等奖, 工作时期参与
    // 具有较强的学习能力,
    // 我的自我介绍完毕.
}
